...
def ConfigsTest():
  input_sizes = [[1,2,2,64],[1,3,3,128],[1,38,38,192],[1,38,38,192],[1,75,75,144],[1,75,75,144],[1,150,150,96],[1,150,150,32]]
  filter_sizes = [[3,3,64,1],[3,3,128,1],[3,3,192,1],[3,3,192,1],[3,3,144,1],[3,3,144,1],[3,3,96,1],[3,3,32,1]]
  out_sizes = [[1,1,1,64],[1,2,2,128],[1,19,19,192],[1,38,38,192],[1,38,38,144],[1,75,75,144],[1,75,75,96],[1,150,150,32]]
  strides = [2,2,2,1,2,1,2,1]
  VALID = "VALID"
  SAME = "SAME"
  paddings = [VALID,SAME,VALID,SAME,SAME,SAME,VALID,SAME]
